...
//    	
//        System.out.println("ClamAV scanning ");
//
//    	
//        try (Socket socket = new Socket("localhost", 3310)) {
// 
//            // ClamAV command
//            System.out.println("ClamAV command ");
//
...
// 
//            // End stream
//            System.out.println("ClamAV End stream ");
//
//            socket.getOutputStream().write(intToBytes(0));
//            socket.getOutputStream().flush();
// 
//            // Read response
//            System.out.println("ClamAV Read response ");
//
...
public class VirusScanService {
    ...
    public boolean scan(InputStream inputStream) {
        try {
            ...
            byte[] response = client.scan(inputStream);
            String result = new String(response);
